...
CONCEPT_GLOSSARY = {
    ...
    "status quo bias": {"definition": "Preference for maintaining the current state", "core": True, "aliases": ["resistance to change", "status quo", "maintaining current", "not want to give up", "reluctant to change", "prefer current"]},
    "escalation of commitment": {"definition": "Continuing investment in failing endeavors", "core": True, "aliases": ["sunk cost fallacy", "legacy project", "continuing investment", "failing project", "persistent investment"]},
