...
def validate_answer(parsed_output, require_behavioral=False):
    ...
    try:
        ...
        if word_count < 125:
            return False, f"Too short: {word_count} words (minimum 125)"
...
SYSTEM_PROMPT_ONE_CALL = """You are Engent Labs Decision-Making Tutor.
...
Write like you're talking to a friend, not a textbook. Use contractions, varied sentence structures, and natural flow.
