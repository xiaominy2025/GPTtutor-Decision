# Simple V1666 Architecture Deployment Script
# Follows exact V1666 design: api_server.py (backend) + query_engine.py (processing) + courses/decision/ (metadata)

Write-Host "🚀 Starting V1666 Architecture Deployment..." -ForegroundColor Green

# Step 1: Create fresh directory
Write-Host "`n📁 Step 1: Creating fresh deployment directory..." -ForegroundColor Yellow
$freshDir = "v1666_final"
...
$freshZip = "gpttutor-v1666-final.zip"
...
Write-Host "`n✅ V1666 Architecture Deployment Complete!" -ForegroundColor Green
